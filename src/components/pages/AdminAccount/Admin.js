...
export default function Admin() {
  ...
  const outlets = [
    ...
    "PUREGOLD PPCI - VIGAN",
    "PUREGOLD PPCI - BOCAUE",
    "PUREGOLD PPCI - GENTRI",
    ...
    "S&R GENTRI",
    "SW OLIVAREZ PLAZA",
    "PUREGOLD PPCI - BALIUAG",
    "PUREGOLD JR - TANOS",
    "PUREGOLD - VICTORIA",
    "PUREGOLD DV - BANLIC",
    "PUREGOLD  - HALANG CALAMBA",
    "PUREGOLDPPCI - PAYATAS",
    "PUREGOLD PPCI - BALIBAGO",
    "PUREGOLD PPCI - STA CRUZ",
    "PUREGOLD  - TAGAPO",
    "PUREGOLD PPCI -  STA CRUZ",
    "RS RP METRO EAST",
    "NB RP METRO EAST",
    ...
    "GAISANO MALL TAGUM",
    "GAISANO MALL DIGOS",
    "GAISANO GRAND ILLUSTRE",
    "GAISANO GRAND TORIL",
    "GAISANO GRAND CALINAN",
    "GAISANO GRAND TAGUM",
    "ROBINSON KETKAI CDO",
    "ROBINSON ROSARIO CDO",
    "ROBINSON GUSA CDO",
    "TMP AYALA CDO",
    "SHOPWISE CDO",
    "S&R CDO",
    "GAISANO GRAND FIESTAMALL TABUNOK",
